...
declare function exportFromJSON<R = void>({ data, fileName, extension, fileNameFormatter, fields, exportType, replacer, space, processor, withBOM, beforeTableEncode, delimiter, }: IOption<R>): R;
